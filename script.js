...
var translations = {
    en: {
        ...
        // Videos page: the scroll-driven reel and the rail underneath it
        reelCue: 'Scroll to run the film',
        reelBeat1Eyebrow: '01 / the reel',
        reelBeat1Title: 'This is a film, and you are running it',
        reelBeat1Body: 'Scroll on to move it forward. Scroll back and it runs backwards. Every frame was shot, cut and graded by me.',
        reelBeat2Eyebrow: '02 / how I work',
        reelBeat2Title: 'Scripts and scenes, then the camera',
        reelBeat2Body: 'As PR and social lead for Job Fair 2026 I wrote the scripts, staged the scenes, shot them and cut them together. Four ads, the opening film, and a campaign that reached television three times.',
        reelBeat3Eyebrow: '03 / the bands',
        reelBeat3Title: 'Music is where most of it starts',
        reelBeat3Body: 'Promos and teasers for the bands I grew up around in Skopje. Golemata Voda, Perseida, Marigold. The film you are scrolling is the Perseida spot.',
        reelBeat4Eyebrow: '04 / the kit',
        reelBeat4Title: 'One body, two primes, whatever light there is',
        reelBeat4Body: 'A Fujifilm X-T2 and the hour I am given. Golden hour, handheld, no lighting truck and no second take.',
        reelMark1: 'Prilep, first light',
        reelMark2: '35mm, wide open',
        reelMark3: 'Handheld, one take',
        reelMark4: 'The close-up',
        reelMark5: 'Backlit, no filter',
        reelMark6: 'Golden hour, 40 minutes',
        reelMark7: 'Cut on movement',
        reelMark8: 'Graded warm',
        reelMark9: 'End of reel',
        reelRailTitle: 'Everything I have shot',
        reelRailHint: 'Drag, or use the arrows',
    ...
    mk: {
        ...
        // Videos page: the scroll-driven reel and the rail underneath it
        reelCue: 'Скролај за да го пуштиш филмот',
        reelBeat1Eyebrow: '01 / снимката',
        reelBeat1Title: 'Ова е филм, и ти го движиш',
        reelBeat1Body: 'Скролај надолу и оди напред. Врати се нагоре и оди наназад. Секој кадар е снимен, монтиран и обоен од мене.',
        reelBeat2Eyebrow: '02 / како работам',
        reelBeat2Title: 'Сценарио и сцени, па камера',
        reelBeat2Body: 'Како одговорен за PR и социјални мрежи на Job Fair 2026 ги пишував сценаријата, ги поставував сцените, ги снимав и ги монтирав. Четири реклами, видеото од отворањето и кампања што стигна три пати на телевизија.',
        reelBeat3Eyebrow: '03 / бендовите',
        reelBeat3Title: 'Музиката е местото каде почнува сè',
        reelBeat3Body: 'Промоции и тизери за бендовите со кои пораснав во Скопје. Големата Вода, Perseida, Marigold. Филмот што го скролаш е спотот за Perseida.',
        reelBeat4Eyebrow: '04 / опремата',
        reelBeat4Title: 'Едно тело, две леќи, светлината што ја има',
        reelBeat4Body: 'Fujifilm X-T2 и часот што ми е даден. Златен час, од рака, без камион со светла и без втор обид.',
        reelMark1: 'Прилеп, прва светлина',
        reelMark2: '35mm, отворена бленда',
        reelMark3: 'Од рака, еден обид',
        reelMark4: 'Крупен план',
        reelMark5: 'Контра светло, без филтер',
        reelMark6: 'Златен час, 40 минути',
        reelMark7: 'Рез на движење',
        reelMark8: 'Топла корекција',
        reelMark9: 'Крај на снимката',
        reelRailTitle: 'Сè што сум снимил',
        reelRailHint: 'Влечи, или користи ги стрелките',
